...
var file_proto_auth_auth_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xbc, 0x01, 0x0a, 0x07, 0x53,
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	2, // 3: mu.micro.book.srv.auth.Service.MakeAccessToken:output_type -> mu.micro.book.srv.auth.Response
	2, // 4: mu.micro.book.srv.auth.Service.DelUserAccessToken:output_type -> mu.micro.book.srv.auth.Response
